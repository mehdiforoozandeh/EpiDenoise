...
if __name__=="__main__":
    e = EVAL(
        model= "models/EpiDenoise22_20240225192715_params1043443.pt", 
        hyper_parameters_path="models/hyper_parameters22_EpiDenoise22_20240225192715_params1043443.pkl",
