...
if __name__=="__main__":
    ...
    e = EVAL(
        model= "models/EpiDenoise22_20240303122821_params6996835.pt", 
        hyper_parameters_path="models/hyper_parameters22_EpiDenoise22_20240303122821_params6996835.pkl",
