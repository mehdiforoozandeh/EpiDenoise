...
def load_region_chromatin_states(parsed_path, chrom, start, end, resolution=25):
    ...
    with np.load(npz_file, allow_pickle=True) as data:
        ...
        print(f"Number of unique chromatin states: {len(np.unique(chr_data))}")
...
if __name__ == "__main__": 
    ...
    if sys.argv[1] == "check":
        ...
        cs = load_region_chromatin_states(parsed_path, "chr1", 1000000//8, (1000000+200)//8, resolution=200)
        print(cs)
    else:
        d = GET_DATA()
