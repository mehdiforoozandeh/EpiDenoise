...
hyperparameters_list = [
    ...
    # "--data_path /project/compbio-lab/encode_data/ --dropout 0.1 --pool_size 2 --epochs 10 --inner_epochs 1 --mask_percentage 0.1 --num_loci 1500 --lr_halflife 1 --min_avail 1 --hpo --eic --n_cnn_layers 3 --conv_kernel_size 3 --expansion_factor 3 --nhead 9 --n_sab_layers 2 --context_length 1200 --pos_enc relative --batch_size 50 --learning_rate 1e-3 --dna --suffix CL1200_nC3_k3_ef3_sepDec --separate_decoders",
    "--data_path /project/compbio-lab/encode_data/ --dropout 0.1 --pool_size 2 --epochs 10 --inner_epochs 1 --mask_percentage 0.1 --num_loci 1500 --lr_halflife 1 --min_avail 1 --hpo --eic --n_cnn_layers 3 --conv_kernel_size 3 --expansion_factor 3 --nhead 9 --n_sab_layers 2 --context_length 1200 --pos_enc relative --batch_size 50 --learning_rate 1e-3 --dna --suffix CL1200_nC3_k3_ef3_shrDec",

    "--data_path /project/compbio-lab/encode_data/ --dropout 0.1 --pool_size 2 --epochs 5 --inner_epochs 1 --mask_percentage 0.1 --num_loci 3000 --lr_halflife 1 --min_avail 1 --hpo --eic --n_cnn_layers 3 --conv_kernel_size 3 --expansion_factor 3 --nhead 9 --n_sab_layers 2 --context_length 1200 --pos_enc relative --batch_size 50 --learning_rate 1e-3 --dna --suffix CL1200_nC3_k3_ef3_hiLoci --separate_decoders",
    "--data_path /project/compbio-lab/encode_data/ --dropout 0.1 --pool_size 2 --epochs 20 --inner_epochs 1 --mask_percentage 0.1 --num_loci 750 --lr_halflife 1 --min_avail 1 --hpo --eic --n_cnn_layers 3 --conv_kernel_size 3 --expansion_factor 3 --nhead 9 --n_sab_layers 2 --context_length 1200 --pos_enc relative --batch_size 50 --learning_rate 1e-3 --dna --suffix CL1200_nC3_k3_ef3_hiEpc --separate_decoders",
