...
class EpiDenoise20(nn.Module):
    def __init__(self, 
        ...
        self.conv1 = ConvTower(input_dim, d_model // (1.2**n_cnn_layer), kernel_size, stride, dilation)
        self.convtower = nn.Sequential(*[
            ConvTower(
                d_model // (1.2**(n_cnn_layer-i)), 
                d_model // (1.2**(n_cnn_layer-i-1)),
